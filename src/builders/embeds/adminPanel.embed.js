  ...
  fields.push(
    ...
    { name: '🪜 ขั้นตอน', value: clampText(stepText), inline: false },
    {
      ...
      value: clampText([
        ...
        '• **แก้ของที่ต้องส่ง** : แก้ requirement แบบยกชุดในหน้าต่างเดียว',
        '• **แก้รางวัล** : แก้ reward แบบยกชุด พร้อม spawn command ได้ในหน้าต่างเดียว',
        ...
        '• **ดูเควส** : เปิดตัวอย่างหน้าเดียวกับที่ผู้เล่นเห็น',
        '• **เพิ่มรูปตัวอย่าง** : เพิ่มรูปตัวอย่างใหม่ให้เควสนี้'
      ].join('\n')),
      inline: false
    }
  );
