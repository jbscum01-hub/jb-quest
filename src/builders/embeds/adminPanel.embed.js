...
function buildQuestDetailEmbed(bundle) {
  ...
  fields.push(
    ...
    { name: '🪜 ขั้นตอน', value: clampText(stepText), inline: false },
    {
      ...
      value: clampText([
        ...
        '• **แก้ของที่ต้องส่ง** : แก้แบบยกชุดด้วยรูปแบบ ชื่อ|จำนวน|แสดงผล',
        '• **แก้รางวัล** : แก้แบบยกชุดด้วยรูปแบบ TYPE|ชื่อ|จำนวน|คำสั่ง|แสดงผล',
  ...
  return new EmbedBuilder()
    ...
    .setDescription([
      ...
      `**Fame ขั้นต่ำ:** ${quest.fame_required_display || 0}`,
